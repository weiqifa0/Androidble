			...
			if (iv != null)
			{
				...
				iv.setOnClickListener(new OnClickListener()
				{
					...
					public void onClick(View v)
					{
						...
						if(v != seletedView) {
							if(seletedView != null) {
								((ImageView) seletedView.findViewById(R.id.id_circle_menu_item_image)).setImageResource(R.drawable.item_normal);
							}
							((ImageView) v.findViewById(R.id.id_circle_menu_item_image)).setImageResource(R.drawable.item_selected);
							seletedView = v;
						}
					}
				});
